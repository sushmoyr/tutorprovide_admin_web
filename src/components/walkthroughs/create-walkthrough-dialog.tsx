...
import { useCreateWalkthrough } from "@/hooks/use-walkthroughs";
...
type CreateWalkthroughFormData = z.infer<typeof createWalkthroughSchema>;
...
export function CreateWalkthroughDialog({
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CreateWalkthroughFormData>({
  ...
  const onSubmit = async (data: CreateWalkthroughFormData) => {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          {/* Key & Title side by side */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="walkthrough-key">{t("key")}</Label>
              <Input
                id="walkthrough-key"
            ...
            <div className="space-y-2">
              <Label htmlFor="walkthrough-title">{t("titleColumn")}</Label>
              <Input
          ...
          {/* Video URL */}
          <div className="space-y-2">
            <Label htmlFor="walkthrough-video-url">
              {t("videoUrl")}{" "}
              <span className="text-muted-foreground">({tc("optional")})</span>
            </Label>
            <Input
