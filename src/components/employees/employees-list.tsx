...
import type { EmployeeListItem, EmployeeType, SortOrder } from "@/types";
import type { Gender } from "@/types/tutor-list";

function getEmployeeTypeColor(type: EmployeeType): string {
  switch (type) {
    case "PERMANENT":
                  ...
                  <TableRow key={employee.id} className="hover:bg-muted/50">
                    ...
                    <TableCell className="hidden xl:table-cell">
                      {employee.employeeType ? (
                        <Badge
                          variant="outline"
                          className={getEmployeeTypeColor(
                            employee.employeeType
                          )}
                        >
                          {employee.employeeType}
                    ...
                    <TableCell className="hidden xl:table-cell">
                      <Badge
                        variant="outline"
                        className={getGenderColor(employee.gender)}
                      >
                        {employee.gender}
                      </Badge>
                    </TableCell>
