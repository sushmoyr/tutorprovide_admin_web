...
import type { Department, SortOrder } from "@/types";
...
export function DepartmentsList() {
  ...
  const { data, isLoading, error } = useDepartments({ page, size: pageSize, sortBy, order });
  ...
  if (departments.length === 0 && page === 0) {
    return (
              ...
              <TableRow key={department.id} className="hover:bg-muted/50">
                ...
                <TableCell className="hidden sm:table-cell">
                  <span className="text-sm text-muted-foreground">
                    {format(new Date(department.createdAt), "dd MMM yyyy")}
                  </span>
                </TableCell>
                <TableCell className="hidden sm:table-cell">
                  <span className="text-sm text-muted-foreground">
                    {format(new Date(department.updatedAt), "dd MMM yyyy")}
                  </span>
                </TableCell>
