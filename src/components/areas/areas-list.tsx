...
import type { Area, SortOrder } from "@/types";
    ...
    <>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) => {
            setDistrictFilter(value === "ALL" ? undefined : Number(value));
            setPage(0);
          }}
        >
          <SelectTrigger className="w-[200px]">
            <SelectValue placeholder={t("filterByDistrict")} />
          </SelectTrigger>
          <SelectContent>
      ...
      <EditAreaDialog
        area={areaToEdit}
        open={!!areaToEdit}
        onOpenChange={(open) => !open && setAreaToEdit(null)}
      />
    </>
  );
}
